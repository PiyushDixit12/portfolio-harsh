...
export const About = () => {
    ...
    return (
        <>
            <div className="row d-flex align-items-center py-5" id="about2" data-section='about2' style={{minHeight: "100vh"}}>
